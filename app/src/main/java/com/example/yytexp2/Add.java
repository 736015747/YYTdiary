...
public class Add extends BaseActivity implements OnClickListener{
    ...
    FloatingActionButton ButtonAddCancel,ButtonAddSave;
    FloatingActionButton insert_img;
    EditText EditTextAddTitle,EditTextAddContent;

    TextView EditTextAddAuthor;
    String Author;
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //初始化控件
        ButtonAddCancel = (FloatingActionButton)findViewById(R.id.ButtonAddCancel);
        ButtonAddSave = (FloatingActionButton)findViewById(R.id.ButtonAddSave);
        ...
        insert_img=(FloatingActionButton)findViewById(R.id.insert_img);
