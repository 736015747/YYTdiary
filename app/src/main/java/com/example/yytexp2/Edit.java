...
public class Edit extends BaseActivity implements OnClickListener{  //编辑活动类
    FloatingActionButton ButtonDelete,ButtonSave,ButtonCancel,insert_img;
    EditText EditTextContent,EditTextTitle;
    TextView EditTextEditAuthor,DateText;
    ImageView imageView;
    int tran = 0;
    String Author="";
    String imgP;
    ...
    private void InitNote() {       //进行数据填装
        ...
        Cursor cursor  = db.query("Diary",new String[]{"id","title","author","content","imgP","date"},
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditTextEditAuthor =(TextView) findViewById(R.id.EditTextEditAuthor);
